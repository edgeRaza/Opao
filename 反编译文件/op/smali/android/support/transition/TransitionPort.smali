...
.method public constructor <init>()V
    ...
    .line 50
    iput-wide v3, p0, Landroid/support/transition/TransitionPort;->mStartDelay:J

    .line 52
    iput-wide v3, p0, Landroid/support/transition/TransitionPort;->mDuration:J
...
.method private captureHierarchy(Landroid/view/View;Z)V
    ...
    .line 731
    iget-object v1, p0, Landroid/support/transition/TransitionPort;->mStartValues:Landroid/support/transition/TransitionValuesMaps;
    ...
    invoke-virtual {v5, v1, v2, v0}, Landroid/support/v4/util/LongSparseArray;->put(JLjava/lang/Object;)V
...
.method protected createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;)V
    ...
    iget-object v1, v0, Landroid/support/transition/TransitionValuesMaps;->viewValues:Landroid/support/v4/util/ArrayMap;

    invoke-direct {v6, v1}, Landroid/support/v4/util/ArrayMap;-><init>(Landroid/support/v4/util/SimpleArrayMap;)V
    ...
    iget-object v1, v0, Landroid/support/transition/TransitionValuesMaps;->idValues:Landroid/util/SparseArray;
    ...
    iget-object v1, v0, Landroid/support/transition/TransitionValuesMaps;->itemIdValues:Landroid/support/v4/util/LongSparseArray;
    ...
    invoke-direct {v8, v1}, Landroid/support/v4/util/LongSparseArray;-><init>(I)V
    ...
    iget-object v4, v0, Landroid/support/transition/TransitionValuesMaps;->itemIdValues:Landroid/support/v4/util/LongSparseArray;

    invoke-virtual {v4, v1}, Landroid/support/v4/util/LongSparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object v4

    invoke-virtual {v8, v2, v3, v4}, Landroid/support/v4/util/LongSparseArray;->put(JLjava/lang/Object;)V
    ...
    .line 218
    invoke-virtual {v6, v1}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 231
    :cond_4
    :goto_4
    invoke-virtual {v7, v12}, Landroid/util/SparseArray;->remove(I)V

    .line 232
    int-to-long v12, v12

    invoke-virtual {p0, v1, v12, v13}, Landroid/support/transition/TransitionPort;->isValidTarget(Landroid/view/View;J)Z
    ...
    .line 228
    invoke-virtual {v6, v5}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 242
    invoke-virtual {v8, v4, v5}, Landroid/support/v4/util/LongSparseArray;->remove(J)V
    ...
    invoke-virtual {p0, v1, v11, v12}, Landroid/support/transition/TransitionPort;->isValidTarget(Landroid/view/View;J)Z
    ...
    invoke-virtual {v2, v11, v12}, Landroid/support/v4/util/LongSparseArray;->get(J)Ljava/lang/Object;
    ...
    .line 255
    invoke-virtual {v8, v11, v12}, Landroid/support/v4/util/LongSparseArray;->remove(J)V
    ...
    .line 266
    :goto_9
    invoke-virtual {v6, v1}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1, v5, v6}, Landroid/support/transition/TransitionPort;->isValidTarget(Landroid/view/View;J)Z
    ...
    .line 284
    invoke-virtual {v8, v3}, Landroid/support/v4/util/LongSparseArray;->keyAt(I)J
    ...
    .line 287
    invoke-virtual {v8, v5, v6}, Landroid/support/v4/util/LongSparseArray;->get(J)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Landroid/support/transition/TransitionValues;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/transition/TransitionPort;->createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 323
    iget-object v6, v2, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;

    .line 324
    invoke-virtual {p0}, Landroid/support/transition/TransitionPort;->getTransitionProperties()[Ljava/lang/String;
    ...
    .line 331
    iget-object v11, v4, Landroid/support/transition/TransitionValues;->values:Ljava/util/Map;

    aget-object v12, v8, v2

    iget-object v13, v1, Landroid/support/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    .line 337
    invoke-virtual {v7, v2}, Landroid/support/v4/util/ArrayMap;->keyAt(I)Ljava/lang/Object;
    ...
    .line 338
    invoke-virtual {v7, v1}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 339
    iget-object v11, v1, Landroid/support/transition/TransitionPort$AnimationInfo;->values:Landroid/support/transition/TransitionValues;

    if-eqz v11, :cond_18

    iget-object v11, v1, Landroid/support/transition/TransitionPort$AnimationInfo;->view:Landroid/view/View;

    if-ne v11, v6, :cond_18

    iget-object v11, v1, Landroid/support/transition/TransitionPort$AnimationInfo;->name:Ljava/lang/String;

    if-nez v11, :cond_15

    .line 340
    invoke-virtual {p0}, Landroid/support/transition/TransitionPort;->getName()Ljava/lang/String;
    ...
    .line 342
    :cond_16
    iget-object v1, v1, Landroid/support/transition/TransitionPort$AnimationInfo;->values:Landroid/support/transition/TransitionValues;

    invoke-virtual {v1, v4}, Landroid/support/transition/TransitionValues;->equals(Ljava/lang/Object;)Z
    ...
    .line 354
    new-instance v4, Landroid/support/transition/TransitionPort$AnimationInfo;
    ...
    invoke-direct {v4, v2, v6, v8, v1}, Landroid/support/transition/TransitionPort$AnimationInfo;-><init>(Landroid/view/View;Ljava/lang/String;Landroid/support/transition/WindowIdPort;Landroid/support/transition/TransitionValues;)V
