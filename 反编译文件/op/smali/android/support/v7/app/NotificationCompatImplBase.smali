...
.method public static applyStandardTemplate(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {p0, p5, v3, v7, v0}, Landroid/support/v7/app/NotificationCompatImplBase;->createIconWithBackground(Landroid/content/Context;IIII)Landroid/graphics/Bitmap;
    ...
    .line 324
    invoke-static {p0, p5, v7}, Landroid/support/v7/app/NotificationCompatImplBase;->createColoredBitmap(Landroid/content/Context;II)Landroid/graphics/Bitmap;
...
.method private static generateContentViewMedia(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    sget v14, Landroid/support/v7/appcompat/R$layout;->notification_template_media_custom:I
    ...
    .line 96
    :goto_1
    sget v1, Landroid/support/v7/appcompat/R$id;->media_actions:I
    ...
    .line 85
    :cond_0
    sget v14, Landroid/support/v7/appcompat/R$layout;->notification_template_media:I
    ...
    check-cast v1, Landroid/support/v4/app/NotificationCompatBase$Action;
    ...
    .line 107
    sget v6, Landroid/support/v7/appcompat/R$id;->media_actions:I
    ...
    .line 111
    sget v1, Landroid/support/v7/appcompat/R$id;->end_padder:I
    ...
    .line 112
    sget v1, Landroid/support/v7/appcompat/R$id;->cancel_action:I
    ...
    .line 114
    invoke-virtual {v4, v1, v2, v3}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
