...
.method public constructor <init>(Landroid/widget/PullingLayout;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
...
.method private a(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    iget-object v2, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    iget-object v4, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    invoke-virtual {p0, v1, v2}, Landroid/widget/PullingLayout$HeadView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v1, p0, Landroid/widget/PullingLayout$HeadView;->e:Landroid/widget/ImageView;

    iget-object v1, p0, Landroid/widget/PullingLayout$HeadView;->e:Landroid/widget/ImageView;

    new-instance v6, Landroid/widget/PullingLayout$PullDownDrawable;

    iget-object v7, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    iget-object v6, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    iget-object v8, p0, Landroid/widget/PullingLayout$HeadView;->e:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Landroid/widget/PullingLayout$HeadView;->b:Landroid/widget/ImageView;

    iget-object v1, p0, Landroid/widget/PullingLayout$HeadView;->b:Landroid/widget/ImageView;
    ...
    iget-object v10, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    iget-object v9, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;
    ...
    iget-object v9, p0, Landroid/widget/PullingLayout$HeadView;->b:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Landroid/widget/PullingLayout$HeadView;->c:Landroid/widget/TextView;

    iget-object v1, p0, Landroid/widget/PullingLayout$HeadView;->c:Landroid/widget/TextView;

    iget-object v9, p0, Landroid/widget/PullingLayout$HeadView;->a:Landroid/widget/PullingLayout;

    invoke-static {v9}, Landroid/widget/PullingLayout;->k(Landroid/widget/PullingLayout;)Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/widget/PullingLayout$HeadView;->c:Landroid/widget/TextView;
    ...
    iget-object p1, p0, Landroid/widget/PullingLayout$HeadView;->d:Landroid/widget/ImageView;
...
.method public getLoadingView()Landroid/widget/ImageView;
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$HeadView;->b:Landroid/widget/ImageView;
...
.method public getPullView()Landroid/widget/ImageView;
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$HeadView;->e:Landroid/widget/ImageView;
...
.method public getStateText()Landroid/widget/TextView;
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$HeadView;->c:Landroid/widget/TextView;
